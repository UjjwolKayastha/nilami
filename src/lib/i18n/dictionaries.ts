...
const en = {
  ...
  home: {
    ...
    mapCaption: "Districts with properties currently on offer — tap a marker to filter.",
    mapEmpty: "No properties on offer yet.",
    mapCount: (n: number) => `${n} ${n === 1 ? "property" : "properties"}`,
    mapView: "View auctions →",
...
const ne: typeof en = {
  ...
  home: {
    ...
    mapCaption: "हाल निलामीमा रहेका सम्पत्ति भएका जिल्लाहरू — छान्न मार्करमा थिच्नुहोस्।",
    mapEmpty: "अहिलेसम्म कुनै सम्पत्ति छैन।",
    mapCount: (n: number) => `${n} सम्पत्ति`,
    mapView: "निलामी हेर्नुहोस् →",
  ...
  listing: {
    ...
    showing: (from: number, to: number, total: number) =>
      `${total} मध्ये ${from}–${to} देखाइँदै`,
    perPage: "प्रति पृष्ठ",
    pagination: "पृष्ठ नेभिगेसन",
    prevPage: "अघिल्लो पृष्ठ",
    nextPage: "अर्को पृष्ठ",
    gotoPage: (n: number) => `पृष्ठ ${n} मा जानुहोस्`,
    pageOf: (n: number, total: number) => `${total} मध्ये पृष्ठ ${n}`,
